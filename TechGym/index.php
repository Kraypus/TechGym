                ...
                <div class="l8 s12 centrecontent">
                    ...
                    <div class="w3-row-padding" id="trainers">
                      <div class="w3-third w3-container w3-margin-bottom">
                        ...
                        <img src="images/Chad-1.jpg" style="width:100%;" class="w3-hover-opacity pfp">
                      ...
                      <div class="w3-third w3-container w3-margin-bottom">
                      <div class="w3-display-container">
                        <img src="images/Chad-2.jpg" style="width:100%" class="w3-hover-opacity pfp">
                      ...
                      <div class="w3-display-container" style="">
                        <img src="images/Chad-3.jpg" style="width:100%" class="w3-hover-opacity pfp">
                    ...
                    <div class="w3-card-4 w3-margin box section" id="aboutus">
                          <div class="w3-container" style="color: white;">
                          <p><h5>GymTech, nudi sledeće usluge I pogodnosti:</h5></p>
